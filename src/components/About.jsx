        ...
        <>
            <div className="p-5">
                <div className="flex flex-col">
                    {/* Title section */}
                    <div className="slide-in-top font-jersey text-kuning text-center md:text-right lg:text-right">
                        <h1 className="text-3xl md:text-6xl lg:text-8xl">About</h1>
                        <h5 className="text-3xl">It's about the game actually!</h5>
                    </div>

                    {/* Content section - reversed on mobile */}
                    <div className="flex flex-col md:grid md:grid-cols-2 gap-8">
                        {/* Paragraph - comes second on mobile, first on desktop */}
                        <div className="order-1 md:order-2 flex flex-col justify-center">
                            <p className="text-kuning font-jersey text-xl md:text-2xl text-justify">
                        ...
                        {/* Carousel - comes first on mobile, second on desktop */}
                        <div className="order-2 md:order-1 flex justify-center">
                            <div id="indicators-carousel" className="relative w-56 md:w-96" data-carousel="static">
                                {/* Carousel wrapper */}
                                <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                                    {/* Item 1 */}
                                    <div className="hidden duration-700 ease-in-out" data-carousel-item="active">
                                        <img src="../../public/images/about.svg"
                                ...
                                <div className="absolute z-30 flex -translate-x-1/2 space-x-3 rtl:space-x-reverse bottom-5 left-1/2">
                                    ...
                                    <button type="button" className="w-3 h-3 rounded-full bg-kuning" aria-current="false"
                                ...
                                <button type="button"
                                        ...
                                        data-carousel-prev>
                                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-kuning">
