        ...
        <>
            <div className="p-5">
                <div className="grid grid-cols-2">
                    <div className="order-1 flex justify-center pr-5">
                        <div id="indicators-carousel" className="relative w-56 md:w-full" data-carousel="static">
                            {/* Carousel wrapper */}
